...
//        PreparedStatement prep = conn.prepareStatement("select idx, msg from (values(?, ?), (2, 'World!')) as T(idx, msg)");
//        prep.setInt(1, 1);
//        prep.setString(2, "Hello");
//        ResultSet rs = prep.executeQuery();
//        rs.next();
...
//        assertEquals(2, rs.getInt(1));
    ...
    private void testObject(Connection conn) throws SQLException {
        ...
        prep.setObject(13, new java.util.Date(Date.valueOf(
                "2001-02-03").getTime()));
        ...
        prep.setObject(20, new BigInteger("12345"), Types.JAVA_OBJECT);

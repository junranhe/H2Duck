...
//        testException();
    ...
    private void testRootCause() throws SQLException {
        ...
        try {
            ...
            assertContains(e.toString().toLowerCase(), "TEST_X".toLowerCase());
            e = e.getNextException();
            assertNotNull(e);
            assertContains(e.toString().toLowerCase(), "TEST_X".toLowerCase());
            e = e.getNextException();
            assertNotNull(e);
            assertContains(e.toString().toLowerCase(), "TEST_Y".toLowerCase());
            e = e.getNextException();
            assertNull(e);
        }
        ...
        System.out.println("set TEST_X");
        prep.addBatch();
        System.out.println("addBatch 1");
        prep.setString(1, "TEST_Y");
        System.out.println("set TEST_Y");
        prep.addBatch();
        System.out.println("addBatch 2");
        try {
            prep.executeBatch();
        } catch (SQLException e) {
